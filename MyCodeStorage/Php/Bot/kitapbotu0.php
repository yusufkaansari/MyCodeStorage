...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    for ($i=1; $i <=10 ; $i++) {
      ...
      $baslikpg[$i-(1)]=$baslik;
      preg_match_all('@<img class="lazyloaded" data-src="(.*?)" alt=@si',$veri[$i-1],$resimurl);
    ...
    fwrite($fp, $myJSON);
    fclose($fp);
    echo "<h3> kitapbotu.json dosyası oluşturuldu. Dosyayı açmak için <a href='kitapbotu.json' target='_blank'>tıklayın</a></h3>";
  } else {
    echo "<h3> kitapbotu.json dosyası daha önce oluşturulmuş. Dosyayı açmak için <a href='kitapbotu.json' target='_blank'>tıklayın</a></h3>";
  }
    ?>
  </body>
</html>
